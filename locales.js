module.exports = {
    ...
    'zh-cn': {
        ...
        'tj2560Ps2.name': 'PS2 遥控器',
        'tj2560Ps2.description': 'PS2 无线遥控器。',
        'tj2560FiveRgbLed.name': '5 全彩Led',
        'tj2560FiveRgbLed.description': '5 全彩Led模块。',
        'tj2560Led.name': 'Led',
        'tj2560Led.description': 'led模块。',
        'tj2560RgbLed.name': '全彩LED',
        'tj2560RgbLed.description': '全彩led模块。',
        'tj2560BumpSwitch.name': '触碰传感器',
        'tj2560BumpSwitch.description': '触碰传感器模块。',
        'tj2560Button.name': '开关模块',
        'tj2560Button.description': '单路开关模块。',
        'tj2560Dht11.name': 'DHT11传感器',
        'tj2560Dht11.description': 'DHT温湿度传感器模块。',
        'tj2560DoubleLineTracker.name': '双循迹传感器',
        'tj2560DoubleLineTracker.description': '双循迹传感器模块。',
        'tj2560DoubleTouchButton.name': '双触摸按键',
        'tj2560DoubleTouchButton.description': '双触摸按键模块。',
        'tj2560FlameIntensity.name': '火焰强度传感器',
        'tj2560FlameIntensity.description': '火焰强度传感器模块。',
        'tj2560FourButton.name': '四路开关模块',
        'tj2560FourButton.description': '四路开关模块。',
        'tj2560LightIntensity.name': '光线强度传感器',
        'tj2560LightIntensity.description': '光线强度传感器模块。',
        'tj2560LineTraker.name': '循迹传感器',
        'tj2560LineTraker.description': '单路循迹传感器模块。',
        'tj2560Potentiometer.name': '电位器',
        'tj2560Potentiometer.description': '电位器模块。',
        'tj2560SmokeConcentration.name': '烟雾传感器',
        'tj2560SmokeConcentration.description': '烟雾传感器模块。',
        'tj2560SmokeRocker.name': '摇杆',
        'tj2560SmokeRocker.description': '摇杆模块。',
        'tj2560SoilMoisture.name': '土壤湿度传感器',
        'tj2560SoilMoisture.description': '土壤湿度传感器模块。',
        'tj2560Sound.name': '声音传感器',
        'tj2560Sound.description': '声音传感器模块。',
